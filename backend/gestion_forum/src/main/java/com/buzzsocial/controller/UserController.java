...
public class UserController {
    ...
    @Operation(summary = "Get user followings", description = "Returns a list of users that the specified user follows")
    public ResponseEntity<List<UserDto>> getUserFollowings(
            @PathVariable String id,
            HttpServletRequest request) {
        String currentUserId = (String) request.getAttribute("userId");
